defmodule BoundaryWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BoundaryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BoundaryWeb.Gettext, "errors", msg, opts)
    end
  end
